...
export default function WhyUs() {
  return (
    <section id="whyUs" className=" bg-gray-50 py-16 px-4 md:px-20">
      <h2 className="text-3xl md:text-4xl font-bold text-center mb-4">
        Why Creators Love Our Workflow 🚀
      </h2>
      <p className="text-center text-gray-500 max-w-2xl mx-auto mb-10">
        A simple visual comparison between the old way (pain) and our new
        solution
      </p>
      ...
      <motion.div
        className="bg-primary-50 rounded-2xl p-8 border border-primary-100 max-w-[56rem] mt-4 mx-auto"
        ...
        <div className="flex flex-col md:flex-row items-center justify-between">
          <div className="mb-6 md:mb-0 md:mr-8">
            ...
            <p className="mt-2 text-gray-600">
              Our platform eliminates the endless cycle of downloading and
              uploading, saving you hours each week.
            </p>
          </div>
          <div className="flex flex-col sm:flex-row gap-4 mx-auto">
            {stats.map((stat, index) => (
              ...
              >
                <div className="text-accent-500 font-bold text-2xl">
                  {stat.value}
                </div>
