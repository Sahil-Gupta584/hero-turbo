...
export async function POST(req: NextRequest) {
    try {
        ...
        const isVideoExist = await prisma.video.findUnique({ where: { id: formdata.videoId } });
        ...
        return NextResponse.json({ message: "Video Published successfully", ok: true, data: videoResponse });
    } catch (error) {
